...
import com.project.micro.resources.CountryResource;
...
public class CountryServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            resourceConfig.register(CountryResource.class);
            ...
            Logger.getLogger(CountryServer.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
